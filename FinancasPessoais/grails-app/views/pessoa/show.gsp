	...
	<body>
		...
		<div id="show-pessoa" class="content scaffold-show" role="main">
			...
			<ol class="property-list pessoa">
				...
				<g:if test="${pessoaInstance?.salario}">
				<li class="fieldcontain">
					<span id="salario-label" class="property-label"><g:message code="pessoa.salario.label" default="Salario" /></span>
					
						<span class="property-value" aria-labelledby="salario-label"><g:fieldValue bean="${pessoaInstance}" field="salario"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${pessoaInstance?.sitFinanceira}">
				<li class="fieldcontain">
					<span id="sitFinanceira-label" class="property-label"><g:message code="pessoa.sitFinanceira.label" default="Sit Financeira" /></span>
					
						<span class="property-value" aria-labelledby="sitFinanceira-label"><g:fieldValue bean="${pessoaInstance}" field="sitFinanceira"/></span>
